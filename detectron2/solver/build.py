...
@Last Modified: 2020-11-27 20:32:46
...
def build_optimizer(cfg: CfgNode, model: torch.nn.Module) -> torch.optim.Optimizer:
    ...
    optimizer_kwargs = {"params": params, "lr": cfg.SOLVER.BASE_LR}
    ...
    return maybe_add_gradient_clipping(cfg, optimizer)(**optimizer_kwargs)
