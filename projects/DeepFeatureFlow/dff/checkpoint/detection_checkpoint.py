# -*- encoding: utf-8 -*-
"""
@File          :   detection_checkpoint.py
@Time          :   2020/06/28 16:55:08
@Author        :   Facebook, Inc. and its affiliates.
@Modified By   :   Jianhu Chen (jhchen.mail@gmail.com)
@Last Modified :   2020/07/01 23:05:04
...
class DetectionCheckpointer(Checkpointer):
    ...
    def _load_model(self, checkpoint):
        if checkpoint.get("matching_heuristics", False):
            ...
            if "flow_div" in checkpoint["model"].keys():
                ...
                _fliter_out_key_startswith(model_state_dict, "flownet")
        ...
        for k in ["pixel_mean", "pixel_std", "flownet_pixel_mean", "flownet_pixel_std"]:
    ...
    def load_flownet(self, path):
        self.load(path, checkpointables=[])
