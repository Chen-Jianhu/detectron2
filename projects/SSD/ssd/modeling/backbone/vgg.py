# -*- encoding: utf-8 -*-
"""
@File         : /detectron2/projects/SSD/ssd/modeling/backbone/vgg.py
@Time         : 2020-11-24 17:43:21
@Author       : Facebook, Inc. and its affiliates.
@Last Modified: 2020-11-24 23:36:14
...
class VGG(Backbone):
    """
    This module implements :paper: `VGG`.
...
def build_ssd_vgg_backbone(cfg, input_shape):
    ...
    vgg = VGG(stage_args, out_features=out_features, fc_to_conv=fc_to_conv)
