# -*- encoding: utf-8 -*-
"""
@File          :   imagenet_vid_evaluation.py
@Time          :   2020/06/30 01:46:36
@Author        :   Facebook, Inc. and its affiliates.
@Modified By   :   Jianhu Chen (jhchen.mail@gmail.com)
@Last Modified :   2020/07/01 23:06:51
...
class ImageNetVIDEvaluator(DatasetEvaluator):
    """
    ...
    def process(self, inputs, outputs):
        ...
        for input, output in zip(inputs, outputs):
            ...
            if "instances" in output:
                ...
                # instances_to_coco_json(instances, input["image_id"])
